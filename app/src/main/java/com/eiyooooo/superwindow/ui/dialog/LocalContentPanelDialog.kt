package com.eiyooooo.superwindow.ui.dialog
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        lifecycleScope.launch {
            withContext(Dispatchers.IO) {
                allAppsList.clear()
                SystemServices.userManager.userProfiles.forEach {
                    allAppsList.addAll(SystemServices.launcherApps.getActivityList(null, it))
                }
